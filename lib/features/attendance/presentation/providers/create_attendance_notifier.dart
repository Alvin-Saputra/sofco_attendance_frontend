...
class CreateAttendanceNotifier extends Notifier<CreateAttendanceState> {
  // Wajib definisikan state awal di sini
  @override
  CreateAttendanceState build() {
    ...
    switch (result) {
      case Success():
        state = state.copyWith(
          ...
          attendanceData: result.data.item,
        );
...
final createAttendanceNotifierProvider =
    NotifierProvider<CreateAttendanceNotifier, CreateAttendanceState>(() {
      return CreateAttendanceNotifier();
    });
